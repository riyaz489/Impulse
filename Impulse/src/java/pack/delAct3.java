 ...
 */
@WebServlet(name = "delAct3", urlPatterns = {"/delAct3"})
public class delAct3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            PreparedStatement pst =con.prepareStatement("delete from expert where id = ?");
